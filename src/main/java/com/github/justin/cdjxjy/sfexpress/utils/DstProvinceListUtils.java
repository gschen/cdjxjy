...
import com.github.justin.cdjxjy.sfexpress.bean.Params;

public class DstProvinceListUtils {
	/**
	 * 
	 * 获取初始的dstProvince列表
	 * 
	 ...
	 * @return
	 */
	public static List<String> getDstProvinceList() {

		String url = "http://www.sf-express.com/dwr/call/plaincall/ServiceTimeManager.getDesProvinceList.dwr";
		...
		params.add(new BasicNameValuePair(Params.BATCHID, "1"));
