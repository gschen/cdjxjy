...
import com.github.justin.cdjxjy.sfexpress.constants.SfexpressTable;
...
public class DBUtils {
	...
	public static void createDb(String dbName) {
		try {
			FileUtils.copyInputStreamToFile(DBUtils.class.getClassLoader()
					.getResourceAsStream("demo.accdb"), new File(dbName));
		} catch (IOException e) {
			e.printStackTrace();
			log.error(e);
		}
		DBUtils.dbPath = dbName;
	}
	...
	public static void connect() {
		try {
			...
			connection = DriverManager
					.getConnection(dbUrlString + dbPath, prop);
		} catch (Exception e) {
			e.printStackTrace();
		} finally {
