...
import com.github.justin.cdjxjy.sfexpress.bean.AddTimeInfo;
...
import com.github.justin.cdjxjy.sfexpress.constants.SendTime;

public class ServiceTimeUtils {
	// private static final Logger log =
	// Logger.getLogger(ServiceTimeUtils.class);
	...
	public static double calHours(String deliverTm) {
		...
		try {
			...
			hours = Double.parseDouble(dclFmt.format(hours));
